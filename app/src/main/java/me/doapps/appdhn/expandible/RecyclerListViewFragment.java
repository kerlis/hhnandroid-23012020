...
public class RecyclerListViewFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //adapter
        getDataProvider();
        final MyExpandableItemAdapter myItemAdapter = new MyExpandableItemAdapter(getDataProvider(), getActivity());
...
//        mRecyclerView.addItemDecoration(new SimpleListDividerDecorator(getResources().getDrawable(R.drawable.list_divider), true));
    ...
    public AbstractExpandableDataProvider getDataProvider() {
        return ExampleExpandableDataProviderFragment.mDataProvider;
